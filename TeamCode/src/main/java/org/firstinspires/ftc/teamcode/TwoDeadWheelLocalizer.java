...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 4139.564687; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -5174.455859; // x position of the perpendicular encoder (in tick units)
    }
